 ...
 */
#ifndef HELVETICUM_UTIL_H
#define HELVETICUM_UTIL_H
...
extern const char * const HELVETICUM_CONF_FILENAME;
extern const char * const HELVETICUM_PID_FILENAME;
...
{
    std::string s = strprintf("helveticum-%s", name);
