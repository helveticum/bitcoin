...
#ifndef HELVETICUM_TEST_SCRIPTNUM10_H
#define HELVETICUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Helveticum Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // HELVETICUM_TEST_BIGNUM_H
