...
{
    BOOST_CHECK(TestSplitHost("www.helveticum.org", "www.helveticum.org", -1));
    BOOST_CHECK(TestSplitHost("[www.helveticum.org]", "www.helveticum.org", -1));
    BOOST_CHECK(TestSplitHost("www.helveticum.org:80", "www.helveticum.org", 80));
    BOOST_CHECK(TestSplitHost("[www.helveticum.org]:80", "www.helveticum.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:2113", "127.0.0.1", 2113));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:2113", "127.0.0.1", 2113));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:2113", "::ffff:127.0.0.1", 2113));
    BOOST_CHECK(TestSplitHost("[::]:2113", "::", 2113));
    BOOST_CHECK(TestSplitHost("::2113", "::2113", -1));
    BOOST_CHECK(TestSplitHost(":2113", "", 2113));
    BOOST_CHECK(TestSplitHost("[]:2113", "", 2113));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:2113", "127.0.0.1:2113"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:2113", "[::]:2113"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
