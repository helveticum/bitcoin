...
#ifndef HELVETICUM_WALLET_WALLET_H
#define HELVETICUM_WALLET_WALLET_H
...
public:
     ...
     * on this helveticum node, and set to 0 for transactions that were created
...
#endif // HELVETICUM_WALLET_WALLET_H
