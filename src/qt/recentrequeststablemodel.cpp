    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return HelveticumUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, HelveticumUnits::separatorNever);
            else
                return HelveticumUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+HelveticumUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
