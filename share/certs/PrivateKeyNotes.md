...
unlocked to sign the Helveticum-Qt.app bundle.
...
allowing somebody to distribute a Helveticum-Qt.app or helveticum-qt-setup.exe with a valid
...
that the helveticum-qt.exe file inside the installer had not been tampered with.
