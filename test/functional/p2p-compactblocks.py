...
# TestNode: A peer we use to send messages to helveticumd, and store responses.
...
class CompactBlocksTest(HelveticumTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes helveticumd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that helveticumd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for helveticumd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # helveticumd will not send blocktxn responses for blocks whose height is
