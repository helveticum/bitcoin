Helveticum Core version 0.13.2 is now available from:

  <https://helveticum.org/bin/helveticum-core-0.13.2/>
...
- #8908 `4a974b2` Update helveticum-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow helveticum-tx to create v2 transactions (btcdrak)
