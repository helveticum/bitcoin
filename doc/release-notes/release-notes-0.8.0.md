Helveticum-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/helveticum/files/Helveticum/helveticum-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Helveticum
...
New/changed settings (command-line or helveticum.conf file)
--------------------------------------------------------
