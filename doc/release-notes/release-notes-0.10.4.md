Helveticum Core version 0.10.4 is now available from:

  <https://helveticum.org/bin/helveticum-core-0.10.4/>
...
- #6953 `43c2789` Split helveticum-tx into its own package
- #6953 `dfe0d4d` Include helveticum-tx binary on Debian/Ubuntu
