Helveticum version 0.5.4 is now available for download at:
http://sourceforge.net/projects/helveticum/files/Helveticum/helveticum-0.5.4/
...
http://gitorious.org/helveticum/helveticumd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Helveticum-Qt notifications under Growl 1.3.
Increase required age of Helveticum-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHelveticum properly when installing Helveticum-Qt over it. (Windows)
