Helveticum Core version 0.9.4 is now available from:

  https://helveticum.org/bin/0.9.4/
...
this update is incompatible with the Helveticum system and could lead to consensus
forks.

Helveticum Core released binaries from https://helveticum.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~helveticum/+archive/ubuntu/helveticum
- A third-party or self-compiled Helveticum Core

upgrade to Helveticum Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
