...
This document provides guidelines for internationalization of the Helveticum Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `helveticum_en.ts` remains unchanged.
